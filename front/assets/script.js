...
document.getElementById('song_list_section' + suffix).append(song_section);
    ...
    method: 'GET'
        ...
        method: 'GET',
            ...
            let cover_wrapper = document.createElement('div');
            cover_wrapper.id = 'cover_wrapper_' + song_id + suffix;
            cover_wrapper.classList.add('image_wrapper');
            document.getElementById('song_header_' + song_id + suffix).append(cover_wrapper);
            ...
            document.getElementById('cover_wrapper_' + song_id + suffix).append(song_cover);
...
if (author_id === get_cookie('user_id')) document.getElementById('your_comment_section').append(comment_section);
    ...
    method: 'GET',
        ...
        method: 'GET',
            ...
            pfp_wrapper.id = 'pfp_wrapper_' + comment_id;
            pfp_wrapper.classList.add('image_wrapper');
            document.getElementById('comment_header_' + comment_id).append(pfp_wrapper);
            ...
            document.getElementById('pfp_wrapper_' + comment_id).append(author_pfp);
            let header_text = document.createElement('div');
...
document.getElementById('user_list_section').append(user_section);
    ...
    method: 'GET'
        ...
        const img_url = URL.createObjectURL(blob_pfp);
        let pfp_wrapper = document.createElement('div');
        pfp_wrapper.id = 'pfp_wrapper_' + user_id;
        pfp_wrapper.classList.add('image_wrapper');
        document.getElementById('user_header_' + user_id).append(pfp_wrapper);
        ...
        document.getElementById('pfp_wrapper_' + user_id).append(user_pfp);
        let header_text = document.createElement('div');
...
await setup_header_page();
    ...
    method: 'GET'
        ...
        document.getElementById('main_content').append(user_main_header);
            ...
            pfp_wrapper.classList.add('image_wrapper');
            document.getElementById('user_main_header').append(pfp_wrapper);
            let user_pfp = document.createElement('img');
            user_pfp.src = img_url;
            user_pfp.draggable = false;
            user_pfp.id = 'user_pfp';
            user_pfp.classList.add('main_image');
            document.getElementById('pfp_wrapper').append(user_pfp);
...
await setup_header_page();
    ...
    method: 'GET'
        ...
        method: 'GET'
            ...
            const img_url = URL.createObjectURL(blob_cover);
            let cover_wrapper = document.createElement('div');
            cover_wrapper.id = 'cover_wrapper';
            cover_wrapper.classList.add('image_wrapper');
            document.getElementById('song_main_header').append(cover_wrapper);
            let song_cover = document.createElement('img');
            song_cover.src = img_url;
            song_cover.draggable = false;
            song_cover.id = 'song_cover';
            song_cover.classList.add('main_image');
            document.getElementById('cover_wrapper').append(song_cover);
